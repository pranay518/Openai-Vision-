...
#client = Azureopenai(openai_api_key=os.getenv('OPENAI_API_KEY'),openai_api_base=os.getenv("OPENAI_API_BASE"))
...
if uploaded_file is not None and client.api_key and analyze_button:
    ...
    with st.spinner("Analysing the image ..."):
        ...
        try:
            ...
            for completion in client.chat.completions.create(
                model=os.getenv("OPENAI_GPT_DEPLOYMENT_NAME"), messages=messages, 
                max_tokens=4090, stream=True,
